...
struct LocPoint {
    ...
    LocPoint(double lat_f, double lon_f, double lat_f_mb, double lon_f_mb, double lat_rtk, double lon_rtk, double lat_sd_proj, double lon_sd_proj, int rtk_, int align_, double timestamp_f) {
    ...
    std::string DebugStr(bool with_time = false) {
        ...
        std::string data_str = fmt::format("{:>14.10f},{:>14.10f},{:>14.10f},{:>14.10f},{:>14.10f},{:>14.10f},{:>14.10f},{:>14.10f},{:d},{:d}\n", //
                                           latitude_fusion, longitude_fusion, latitude_fusion_map_b, longitude_fusion_map_b, latitude_rtk, longitude_rtk, latitude_sdmap_proj, longitude_sdmap_proj, rtk_status, align_type);
        if (with_time) {
